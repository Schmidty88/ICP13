...
# here we chaned the out value to 16 so that it will match the in on conv2
...
# with a in of 16 matching our conv1 we then change the out to 36
W_conv2 = weight_variable([5, 5, 16, 36])
b_conv2 = bias_variable([36])

h_conv2 = tf.nn.relu(conv2d(h_pool1, W_conv2) + b_conv2)
h_pool2 = max_pool_2x2(h_conv2)
#just like before we have to make sure we change our in to 36 and out is changed to 128
...
# readout layer was changed from 1024 to 128
